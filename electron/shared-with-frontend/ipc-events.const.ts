...
export enum IPC {
  ...
  TASK_WIDGET_TASKS_UPDATED = 'TASK_WIDGET_TASKS_UPDATED',
  ...
  IMAGE_CACHE_GET_DISPLAY_PATH = 'IMAGE_CACHE_GET_DISPLAY_PATH',
  IMAGE_CACHE_REMOVE = 'IMAGE_CACHE_REMOVE',
  IMAGE_CACHE_GET_PATH_INFO = 'IMAGE_CACHE_GET_PATH_INFO',
  IMAGE_CACHE_PICK_DIRECTORY = 'IMAGE_CACHE_PICK_DIRECTORY',
  ...
  UPDATE_TASK_WIDGET_COUNTDOWN = 'UPDATE_TASK_WIDGET_COUNTDOWN',
  UPDATE_TITLE_BAR_DARK_MODE = 'UPDATE_TITLE_BAR_DARK_MODE',

  GET_PRODUCTIVITY_QUOTES = 'GET_PRODUCTIVITY_QUOTES',
