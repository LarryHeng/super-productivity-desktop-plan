...
export const DEFAULT_GLOBAL_CONFIG: GlobalConfigState = {
  ...
  misc: {
    ...
    countdownNameColor: '#e53935',
    countdownNameFontSize: 14,
    countdownColor: '#e53935',
    countdownDaysColor: '#e53935',
    countdownDaysFontSize: 16,
    countdownCommonColor: '#888888',
    countdownCommonFontSize: 13,
    countdownShowInWidget: true,
    widgetCountdownNameColor: '#e53935',
    widgetCountdownNameFontSize: 14,
    widgetCountdownDaysColor: '#e53935',
    widgetCountdownDaysFontSize: 16,
    widgetCountdownCommonColor: '#888888',
    widgetCountdownCommonFontSize: 13,
    widgetCountdownIsBold: true,
    countdownIsBold: true,
    customTheme: 'default',
    defaultStartPage: 0,
